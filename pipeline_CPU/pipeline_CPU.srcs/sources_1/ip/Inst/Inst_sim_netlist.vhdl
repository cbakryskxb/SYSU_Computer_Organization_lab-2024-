...
-- Command     : write_vhdl -force -mode funcsim -rename_top Inst -prefix
--               Inst_ Inst_sim_netlist.vhdl
-- Design      : Inst
...
\synth_options.dist_mem_inst\: entity work.Inst_dist_mem_gen_v8_0_12_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      spo(24) => \^spo\(31),
      spo(23 downto 10) => \^spo\(29 downto 16),
      spo(9) => \^spo\(14),
